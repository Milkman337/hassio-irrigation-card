...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Lt=/'/g,Ht=/"/g,qt=/^(?:script|style|textarea|title)$/i,$t=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),h=$t(1),Ue=$t(2),Le=$t(3),I=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),Ft=new WeakMap,R=D.createTreeWalker(D,129);ke=(r,e)=>{let t=r.length-1,i=[],n,s=e===2?"<svg>":e===3?"<math>":"",a=q;for(let c=0;c<t;c++){let o=r[c],d,p,m=-1,g=0;for(;g<o.length&&(a.lastIndex=g,p=a.exec(o),p!==null);)g=a.lastIndex,a===q?p[1]==="!--"?a=zt:p[1]!==void 0?a=Ut:p[2]!==void 0?(qt.test(p[2])&&(n=RegExp("</"+p[2],"g")),a=T):p[3]!==void 0&&(a=T):a===T?p[0]===">"?(a=n??q,m=-1):p[1]===void 0?m=-2:(m=a.lastIndex-p[2].length,d=p[1],a=p[3]===void 0?T:p[3]==='"'?Ht:Lt):a===Ht||a===Lt?a=T:a===zt||a===Ut?a=q:(a=T,n=void 0);let _=a===T&&r[c+1].startsWith("/>")?" ":"";s+=a===q?o+Ae:m>=0?(i.push(d),o.slice(0,m)+Zt+o.slice(m)+C+_):o+C+(m===-2?c:_)}return[Wt(r,s+(r[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},V=class r{constructor({strings:e,_$litType$:t},i){let n;this.parts=[];let s=0,a=0,c=e.length-1,o=this.parts,[d,p]=ke(e,t);if(this.el=r.createElement(d,i),R.currentNode=this.el.content,t===2||t===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(n=R.nextNode())!==null&&o.length<c;){if(n.nodeType===1){if(n.hasAttributes())for(let m of n.getAttributeNames())if(m.endsWith(Zt)){let g=p[a++],_=n.getAttribute(m).split(C),P=/([.?@])?(.*)/.exec(g);o.push({type:1,index:s,name:P[2],strings:_,ctor:P[1]==="."?gt:P[1]==="?"?_t:P[1]==="@"?vt:O}),n.removeAttribute(m)}else m.startsWith(C)&&(o.push({type:6,index:s}),n.removeAttribute(m));if(qt.test(n.tagName)){let m=n.textContent.split(C),g=m.length-1;if(g>0){n.textContent=it?it.emptyScript:"";for(let _=0;_<g;_++)n.append(m[_],W()),R.nextNode(),o.push({type:2,index:++s});n.append(m[g],W())}}}else if(n.nodeType===8)if(n.data===jt)o.push({type:2,index:s});else{let m=-1;for(;(m=n.data.indexOf(C,m+1))!==-1;)o.push({type:7,index:s}),m+=C.length-1}s++}}static createElement(e,t){let i=D.createElement("template");return i.innerHTML=e,i}};ft=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,n=(e?.creationScope??D).importNode(t,!0);R.currentNode=n;let s=R.nextNode(),a=0,c=0,o=i[0];for(;o!==void 0;){if(a===o.index){let d;o.type===2?d=new Y(s,s.nextSibling,this,e):o.type===1?d=new o.ctor(s,o.name,o.strings,this,e):o.type===6&&(d=new bt(s,this,e)),this._$AV.push(d),o=i[++c]}a!==o?.index&&(s=R.nextNode(),a++)}return R.currentNode=D,n}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},Y=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,n){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=N(this,e,t),B(e)?e===u||e==null||e===""?(this._$AH!==u&&this._$AR(),this._$AH=u):e!==this._$AH&&e!==I&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Ee(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==u&&B(this._$AH)?this._$AA.nextSibling.data=e:this.T(D.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,n=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=V.createElement(Wt(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===n)this._$AH.p(t);else{let s=new ft(n,this),a=s.u(this.options);s.p(t),this.T(a),this._$AH=s}}_$AC(e){let t=Ft.get(e.strings);return t===void 0&&Ft.set(e.strings,t=new V(e)),t}k(e){wt(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,n=0;for(let s of e)n===t.length?t.push(i=new r(this.O(W()),this.O(W()),this,this.options)):i=t[n],i._$AI(s),n++;n<t.length&&(this._$AR(i&&i._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=Ot(e).nextSibling;Ot(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},O=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,n,s){this.type=1,this._$AH=u,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=u}_$AI(e,t=this,i,n){let s=this.strings,a=!1;if(s===void 0)e=N(this,e,t,0),a=!B(e)||e!==this._$AH&&e!==I,a&&(this._$AH=e);else{let c=e,o,d;for(e=s[0],o=0;o<s.length-1;o++)d=N(this,c[i+o],t,o),d===I&&(d=this._$AH[o]),a||=!B(d)||d!==this._$AH[o],d===u?e=u:e!==u&&(e+=(d??"")+s[o+1]),this._$AH[o]=d}a&&!n&&this.j(e)}j(e){e===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},gt=class extends O{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===u?void 0:e}},_t=class extends O{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==u)}},vt=class extends O{constructor(e,t,i,n,s){super(e,t,i,n,s),this.type=5}_$AI(e,t=this){if((e=N(this,e,t,0)??u)===I)return;let i=this._$AH,n=e===u&&i!==u||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==u&&(i===u||n);n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},bt=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){N(this,e)}},Ce=yt.litHtmlPolyfillSupport;Ce?.(V,Y),(yt.litHtmlVersions??=[]).push("3.3.3");Bt=(r,e,t)=>{let i=t?.renderBefore??e,n=i._$litPart$;if(n===void 0){let s=t?.renderBefore??null;i._$litPart$=n=new Y(e.insertBefore(W(),s),s,void 0,t??{})}return n._$AI(r),n}});var xt,y,Te,Vt=f(()=>{j();j();nt();nt();xt=globalThis,y=class extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Bt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return I}};y._$litElement$=!0,y.finalized=!0,xt.litElementHydrateSupport?.({LitElement:y});Te=xt.litElementPolyfillSupport;Te?.({LitElement:y});(xt.litElementVersions??=[]).push("4.2.2")});var Yt=f(()=>{});var rt=f(()=>{j();nt();Vt();Yt()});var st,Kt=f(()=>{st=r=>(e,t)=>{t!==void 0?t.addInitializer(()=>{customElements.define(r,e)}):customElements.define(r,e)}});function M(r){return(e,t)=>typeof t=="object"?De(r,e,t):((i,n,s)=>{let a=n.hasOwnProperty(s);return n.constructor.createProperty(s,i),a?Object.getOwnPropertyDescriptor(n,s):void 0})(r,e,t)}var Re,De,St=f(()=>{j();Re={attribute:!0,type:String,converter:Z,reflect:!1,hasChanged:et},De=(r=Re,e,t)=>{let{kind:i,metadata:n}=t,s=globalThis.litPropertyMetadata.get(n);if(s===void 0&&globalThis.litPropertyMetadata.set(n,s=new Map),i==="setter"&&((r=Object.create(r)).wrapped=!0),s.set(t.name,r),i==="accessor"){let{name:a}=t;return{set(c){let o=e.get.call(this);e.set.call(this,c),this.requestUpdate(a,o,r,!0,c)},init(c){return c!==void 0&&this.C(a,void 0,r,c),c}}}if(i==="setter"){let{name:a}=t;return function(c){let o=this[a];e.call(this,c),this.requestUpdate(a,o,r,!0,c)}}throw Error("Unsupported decorator location: "+i)}});function S(r){return M({...r,state:!0,attribute:!1})}var Gt=f(()=>{St();});var Jt=f(()=>{});var z=f(()=>{});var Qt=f(()=>{z();});var Xt=f(()=>{z();});var te=f(()=>{z();});var ee=f(()=>{z();});var ie=f(()=>{z();});var At=f(()=>{Kt();St();Gt();Jt();Qt();Xt();te();ee();ie()});var ne,re,ot,Et=f(()=>{(function(r){r.language="language",r.system="system",r.comma_decimal="comma_decimal",r.decimal_comma="decimal_comma",r.space_comma="space_comma",r.none="none"})(ne||(ne={})),function(r){r.language="language",r.system="system",r.am_pm="12",r.twenty_four="24"}(re||(re={}));ot=function(r,e,t,i){i=i||{},t=t??{};var n=new Event(e,{bubbles:i.bubbles===void 0||i.bubbles,cancelable:!!i.cancelable,composed:i.composed===void 0||i.composed});return n.detail=t,r.dispatchEvent(n),n}});var ae,K,ct,oe,ce,le,ue,A,lt=f(()=>{"use strict";ae="1.0.0",K="hassio-irrigation-card",ct="hassio-irrigation-card-editor",oe="mdi:sprinkler-variant",ce="mdi:water-pump",le="mdi:water-pump-off",ue="mdi:electric-switch",A={zoneSwitch:/^switch\.(.+)_zone_(\d+)$/,zoneEnableSwitch:/^switch\.(.+)_enable_zone_(\d+)$/,zoneDuration:/^number\.(.+)_zone_(\d+)_run_duration$/,autoAdvance:/^switch\.(.+)_auto_advance$/,reverse:/^switch\.(.+)_reverse$/,multiplier:/^number\.(.+)_multiplier$/,repeat:/^number\.(.+)_repeat$/,input:/^binary_sensor\.(.+)_(input_\d+|pad_(rx|tx)\d+_as_input)$/}});function G(r){let e=Math.max(0,Math.round(r)),t=Math.floor(e/3600),i=Math.floor(e%3600/60),n=e%60,s=[];return t>0&&s.push(`${t}h`),(t>0||i>0)&&s.push(`${i}m`),s.push(`${n}s`),s.join(" ")}function U(r,e,t=0){if(!e)return t;let i=r.states[e];if(!i||i.state==="unknown"||i.state==="unavailable")return t;let n=Number(i.state);return Number.isFinite(n)?n:t}function J(r,e){return e?r.states[e]?.state==="on":!1}function kt(r,e){if(!e)return!0;let t=r.states[e];return!t||t.state==="unavailable"}function de(r,e,t,i,n){let s=r.states[e.switch],a=s?.state==="on",c=e.enable_switch?J(r,e.enable_switch):!0,o=U(r,e.duration_number,0),d=Math.max(0,o*i),p=d,m=0;if(a&&s?.last_changed){let g=new Date(s.last_changed).getTime(),_=Math.max(0,(n-g)/1e3);p=Math.max(0,d-_),m=d>0?Math.min(100,_/d*100):0}return{config:e,index:t,active:a,enabled:c,durationSeconds:o,effectiveDurationSeconds:d,remainingSeconds:p,progressPct:m,unavailable:kt(r,e.switch)}}function ut(r,e){let t=Object.keys(r.states).filter(l=>e?l.includes(e):!0),i=new Map,n,s,a,c,o=[],d=[];for(let l of t){let k;if(k=l.match(A.zoneSwitch)){let w=Number(k[2]),$=i.get(w)??{switch:""};$.switch=l,$.name=`Zone ${w}`,i.set(w,$);continue}if(k=l.match(A.zoneEnableSwitch)){let w=Number(k[2]),$=i.get(w)??{switch:""};$.enable_switch=l,i.set(w,$);continue}if(k=l.match(A.zoneDuration)){let w=Number(k[2]),$=i.get(w)??{switch:""};$.duration_number=l,i.set(w,$);continue}if(A.autoAdvance.test(l)){n=l;continue}if(A.reverse.test(l)){s=l;continue}if(A.multiplier.test(l)){a=l;continue}if(A.repeat.test(l)){c=l;continue}if(A.input.test(l)){o.push({entity:l});continue}l.startsWith("switch.")&&(!e||l.includes(e))&&d.push(l)}let p=new Set([...i.values()].map(l=>l.switch)),m,g=(n??s)?.replace(/_(auto_advance|reverse)$/,"");g&&(m=d.find(l=>l===g||l.startsWith(g))),m||(m=d.find(l=>!p.has(l)&&!l.includes("internet")));let _=d.find(l=>l.includes("internet")),P=[...i.entries()].sort(([l],[k])=>l-k).map(([,l])=>l).filter(l=>!!l.switch),pe=t.find(l=>l.startsWith("device_tracker.")&&(!e||l.includes(e)));return{controller_switch:m,auto_advance_switch:n,reverse_switch:s,multiplier_number:a,repeat_number:c,internet_switch:_,device_tracker:pe,zones:P,inputs:o}}var Ct=f(()=>{"use strict";lt()});var me={};ge(me,{HassioIrrigationCardEditor:()=>E});var E,he=f(()=>{"use strict";rt();At();Et();lt();Ct();E=class extends y{constructor(){super(...arguments);this._prefixHint="";this._autoDetect=()=>{let t=ut(this.hass,this._prefixHint||void 0);this._config={...this._config,...t,zones:t.zones.length>0?t.zones:this._config.zones},this._emit()}}setConfig(t){this._config={...t,zones:t.zones??[]}}render(){return!this.hass||!this._config?h``:h`
  ...
  `,v([M({attribute:!1})],E.prototype,"hass",2),v([S()],E.prototype,"_config",2),v([S()],E.prototype,"_prefixHint",2),E=v([st(ct)],E)});rt();At();Et();rt();var se=H`
  :host {
    display: block;
  }
...
`;lt();Ct();var Ie=1e3,b=class extends y{constructor(){super(...arguments);this._now=Date.now();this._programCollapsed=!1;this._diagnosticsCollapsed=!0;this._multiplierDraft=null;this._onMultiplierInput=t=>{this._multiplierDraft=Number(t.target.value)};this._onMultiplierChange=t=>{let i=Number(t.target.value);this._setNumber(this._config.multiplier_number,i),this._multiplierDraft=null}}static async getConfigElement(){return await Promise.resolve().then(()=>(he(),me)),document.createElement(ct)}static getStubConfig(t){let i=ut(t);return i.zones.length>0?{type:`custom:${K}`,title:"Irrigation",...i}:{type:`custom:${K}`,title:"Irrigation",zones:[{switch:"switch.REPLACE_ME_zone_1",name:"Zone 1"},{switch:"switch.REPLACE_ME_zone_2",name:"Zone 2"}]}}setConfig(t){if(!t)throw new Error("Invalid configuration");if(t.zones&&!Array.isArray(t.zones))throw new Error("`zones` must be a list");this._config={show_diagnostics:!0,show_multiplier_preview:!0,compact:!1,...t,zones:t.zones??[]},this._programCollapsed=!!this._config.compact}getCardSize(){return 2+Math.ceil((this._config?.zones?.length??0)/3)+(this._config?.show_diagnostics?2:0)}updated(t){super.updated(t);let i=this._zoneStates().some(n=>n.active);i&&!this._tickHandle?this._tickHandle=setInterval(()=>{this._now=Date.now()},Ie):!i&&this._tickHandle&&(clearInterval(this._tickHandle),this._tickHandle=void 0)}disconnectedCallback(){super.disconnectedCallback(),this._tickHandle&&(clearInterval(this._tickHandle),this._tickHandle=void 0)}get _multiplier(){return this._multiplierDraft!==null?this._multiplierDraft:U(this.hass,this._config.multiplier_number,1)}get _repeat(){return U(this.hass,this._config.repeat_number,0)}_zoneStates(){return!this.hass||!this._config?[]:this._config.zones.map((t,i)=>de(this.hass,t,i,this._multiplier,this._now))}get _estimateTotalSeconds(){return this._zoneStates().filter(i=>i.enabled).reduce((i,n)=>i+n.effectiveDurationSeconds,0)*(this._repeat+1)}render(){if(!this._config||!this.hass)return h``;let t=this._zoneStates(),i=t.some(d=>d.active),n=t.find(d=>d.active),s=!!this._config.controller_switch,a=s?J(this.hass,this._config.controller_switch):!1,c=!!this._config.device_tracker,o=c?this.hass.states[this._config.device_tracker]?.state==="home":void 0;return h`
    ...
    `}_renderMasterRow(t,i){return h`
      <div class="master-row">
        ...
        >
          <ha-icon slot="icon" icon=${t?"mdi:stop":"mdi:play"}></ha-icon>
